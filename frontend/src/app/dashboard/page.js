    ...
    if (authLoading) {
        return (
            <div className="dashboard-layout" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
                <p style={{ color: 'var(--text-tertiary, #888)', fontSize: '0.9rem' }}>Authenticating...</p>
            </div>
        );
    }
    ...
    return (
        <div className="dashboard-layout">
            ...
            <aside className="sidebar">
                ...
                {user ? (
                    <div className="sidebar-avatar" title={user.login} style={{ padding: 0, overflow: 'hidden' }}>
                        <img src={user.avatar_url} alt={user.login} style={{ width: '100%', height: '100%', borderRadius: '50%', objectFit: 'cover' }} />
                    </div>
                ) : (
